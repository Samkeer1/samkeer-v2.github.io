...
var sum = function(array) {
  //base case where array length is 1
  if(array.length === 1){
    return array[0];
...
var isEven = function(n) {
  //base case is where n's last digit is either 1 or 0
  if(n === 1){
    return false;
  }else if(n === 0){
    return true;
...
if(n > 0){
  //if n is positive negative increment
  return n - 1 + sumBelow(n - 1);
}else if(n === 0){
  //base case
  return 0;
}else{
  //if n is negative positive increment
  return n + 1 + sumBelow(n + 1);
}
};
...
var palindrome = function(string) {
  //if string is 0 or 1 char long return true 
  let str = string;
...
//if strings are 1 in length
//if strings[0] are equal
//return true
...
var alternateSign = function(array, result = []) {
  ...
  //if result has an undefined length or even length, push positive first element in array
  //return sliced array in function
  else if(!result.length || result.length % 2 === 0){
    //if pos push else make neg positive
    if(array[0] > 0){
      result.push(array[0]);
    }else{
  ...
  //else make the push odd and return sliced array
  else{
    if(array[0] < 0){
      result.push(array[0]);
    }else{
